            ...
            slivers: [
              ...
              SliverAppBar(
                ...
                actions: [
                  ...
                  _AddPartyButton(onTap: () => _addPartyDialog(context)),
                        ...
                        child: Row(
                          children: [
                            GallaFilterChip(
                              ...
                              selected:
                                  _activeTab == KhataTab.customers &&
                                  state.viewMode == LedgerViewMode.parties,
                              onTap: () {
                            ...
                            GallaFilterChip(
                              label: 'Transactions',
                              selected:
                                  state.viewMode == LedgerViewMode.transactions,
                              onTap: () =>
                    ...
                    : (displayedParties.isEmpty
                          ? SliverToBoxAdapter(
                              child: GallaEmptyState(
                                ...
                                body:
                                    'Start your first digital khata and easily track who owes you money.',
                              ...
                              delegate: SliverChildBuilderDelegate((
                                ...
                                return Padding(
                                  ...
                                  child: GallaPartyCard(
                                    party: party,
                                    currency: currency,
                                    daysOverdue: party.balanceMinor > 0
                                        ? 5
                                        : null,
                                    onTap: () => context.push(
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Add New Party / Customer', style: GallaType.numberMd),
